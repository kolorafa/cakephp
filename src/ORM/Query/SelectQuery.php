...
class SelectQuery extends DbSelectQuery implements JsonSerializable, QueryInterface
{
     ...
     * Result set factory
     *
     * @var \Cake\ORM\ResultSetFactory<TSubject>
     */
     ...
     * @return \Cake\Datasource\ResultSetInterface<array-key, TSubject|mixed>
     */
     ...
     *
     * @return \Cake\Datasource\ResultSetInterface<array-key, (TSubject|mixed)> The data to convert to JSON.
     */
